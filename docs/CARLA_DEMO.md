...
1. Now that the server is running, run [`run_carla_demo.sh`](./run_carla_demo.sh) in another terminal to run the carla client.
    ...
    * See `run_carla_demo.sh` help message on how to run manual vs automatic simulation demo.
