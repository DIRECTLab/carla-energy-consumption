...
python3 manual_control_steeringwheel.py ./input/examples/kenworth.csv -w ./input/creation/testlane.csv --res $RES > /dev/null 2>&1 &
python3 navigation/draw_chargers.py ./input/creation/testlane.csv
