...
if __name__ == "__main__":
    ...
    # folder = "DWARF_20230928141733807"
            ...
            for result in results:
                ...
                for j, class_label in enumerate(class_predictions):
                    ...
                    if label == "car" or label == "truck" or label == "bus":
                        ...
                        left_tire = (left_tire_inside[0], left_tire_inside[1])
                        ...
                        car_info.append((left_tire, right_tire, (middle_x, ((left_tire[1] + right_tire[1]) // 2) + y), h-y, tracking_ids[j]))
                        x_y_info.append((x, y))
        ...
        df_csv.to_csv(f"TireLineDetection/data_{folder}.csv")
